 ...
 */
class TaskNote extends \AppBundle\Entity\TaskNote implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\TaskNote' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\TaskNote' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\TaskNote' . "\0" . 'task', 'createdBy', 'updatedBy', 'deletedBy', 'createdAt', 'updatedAt', 'deletedAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TaskNote $proxy) {
