 ...
 */
class Priority extends \AppBundle\Entity\Priority implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Priority' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Priority' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Priority' . "\0" . 'weight', '' . "\0" . 'AppBundle\\Entity\\Priority' . "\0" . 'icon', 'createdBy', 'updatedBy', 'deletedBy', 'createdAt', 'updatedAt', 'deletedAt'];
        }
