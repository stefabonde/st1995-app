...
class Client extends \AppBundle\Entity\Client implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Client' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Client' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Client' . "\0" . 'projects', '' . "\0" . 'AppBundle\\Entity\\Client' . "\0" . 'clientUsers', 'createdBy', 'updatedBy', 'deletedBy', 'createdAt', 'updatedAt', 'deletedAt'];
        }
    ...
    public function setClientUsers($clientUsers)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setClientUsers', [$clientUsers]);

        return parent::setClientUsers($clientUsers);
    }
