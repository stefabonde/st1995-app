 ...
 */
class ClientUser extends \AppBundle\Entity\ClientUser implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\ClientUser' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\ClientUser' . "\0" . 'client', '' . "\0" . 'AppBundle\\Entity\\ClientUser' . "\0" . 'user', 'createdBy', 'updatedBy', 'deletedBy', 'createdAt', 'updatedAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ClientUser $proxy) {
