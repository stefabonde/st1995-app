...
class Task extends \AppBundle\Entity\Task implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Task' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Task' . "\0" . 'title', '' . "\0" . 'AppBundle\\Entity\\Task' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Task' . "\0" . 'assignee', '' . "\0" . 'AppBundle\\Entity\\Task' . "\0" . 'project', '' . "\0" . 'AppBundle\\Entity\\Task' . "\0" . 'priority', '' . "\0" . 'AppBundle\\Entity\\Task' . "\0" . 'taskNotes', 'createdBy', 'updatedBy', 'deletedBy', 'createdAt', 'updatedAt', 'deletedAt'];
        }
    ...
    public function addAssignee($assignee)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addAssignee', [$assignee]);

        return parent::addAssignee($assignee);
    }
    ...
    public function getTaskNotes()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTaskNotes', []);

        return parent::getTaskNotes();
    }
    ...
    public function setTaskNotes($taskNotes)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTaskNotes', [$taskNotes]);

        return parent::setTaskNotes($taskNotes);
    }
