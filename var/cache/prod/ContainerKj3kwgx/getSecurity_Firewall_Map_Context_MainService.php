...
return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(new RewindableGenerator(function () {
    ...
    yield 5 => ${($_ = isset($this->services['security.authentication.switchuser_listener.main']) ? $this->services['security.authentication.switchuser_listener.main'] : $this->load('getSecurity_Authentication_SwitchuserListener_MainService.php')) && false ?: '_'};
