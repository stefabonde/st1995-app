...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/task/new'), [0 => 'ROLE_ADMIN'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/task/.*/edit'), [0 => 'ROLE_ADMIN'], NULL);
